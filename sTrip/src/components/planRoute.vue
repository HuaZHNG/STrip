    ...
    <nav class="main-menu" style="z-index: 12; overflow: hidden;">
      <ul id="pickers">
        ...
        <div id="descrip2">
          <div id="search-box"> <br>
            ...
            <input class="start" id="start" type="text" name="start" @keyup.enter="enterEnterStart" placeholder="start" >
          </div>
          <div id="search-box"> <br>
            <i class="icon-locate"></i>
            <input class="start" id="end" type="text" name="start" @keyup.enter="enterEnterEnd" placeholder="end">
          </div>
          </div>
        </li>
      </ul>
      ...
      <div id="descrip1">
        <el-tooltip effect="dark" content="Click here to plan a route" placement="bottom">
            <el-button size="small" id="submit" class="collect" type="text" style="position: relative; left: 17%;  color: black" @click="calculateAndDisplayRoute">DONE</el-button>
        </el-tooltip>
      </div>
    </nav>
    <footer class="bottom">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      enterEnterStart: function() {
        var address = document.getElementById('start').value
        this.addMaker(address)
      },
      enterEnterEnd: function() {
        var address = document.getElementById('end').value
        this.addMaker(address)
      },
      addMaker: function(address){
        console.log(address)
        geocoder.geocode(
            {
              address: address
